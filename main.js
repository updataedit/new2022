...
// @match        http://m.apollo.****.com/Publish/Page*
// @match        http://m.apollo.****.com/Home/Login*
...
(function() {
    ...
    // 创建超链接
    const links = [
        { href: 'http://m.apollo.****.com/Publish/Page?publish_info_title=&range_type=0&update_type=0', text: '升级页面' },
        { href: 'http://m.apollo.****.com/Home/Login', text: '登录页' },
        { href: 'http://m.apollo.****.com/VersionUpdate/Page', text: '商户id搜索' }
    ];
